...
public class Product {
    ...
    public Product(String pid, String pname, String image, String description) {
        this.pid = pid;
        this.pname = pname;
        this.image = image;
        this.description = description;
    ...
    public Product(String pid, String pname, String image, String description, int cateID) {
        this.pid = pid;
        this.pname = pname;
        this.image = image;
        this.description = description;
